...
public class Constants {
    ...
    public static final String NAME_USER_1 ="Иван";
    public static final String SURNAME_USER_1 ="Иванов";
    public static final String ADRESS_USER_1 ="Ленина 13";
    public static final String PHONE_USER_1 ="+1234567890";
    public static final String COMMENT ="Привезти после 14 часов";

    public static final String NAME_USER_2 ="Петр";
    public static final String SURNAME_USER_2 ="Петров";
    public static final String ADRESS_USER_2 ="ул. Первая дом 2 кв. 3";
    public static final String PHONE_USER_2 ="80123456789";
